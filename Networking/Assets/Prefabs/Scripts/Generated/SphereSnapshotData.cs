...
public struct SphereSnapshotData : ISnapshotData<SphereSnapshotData>
{
    ...
    public void Serialize(int networkId, ref SphereSnapshotData baseline, DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref SphereSnapshotData baseline, DataStreamReader reader, ref DataStreamReader.Context ctx,
